...
# Model options
__C.MODEL = edict()
__C.MODEL.FEATURE_EXTRACTOR = 'resnet50'
...
__C.TRAIN.LR_SCHEDULE = 'exp'
__C.TRAIN.MAX_LOOP = 100
...
__C.EXP = edict()
__C.EXP.LR_DECAY_RATE = 0.9
__C.EXP.LR_DECAY_STEP = 100
...
__C.CLUSTERING.EPS = 0.05
__C.CLUSTERING.FILTERING_THRESHOLD = 0.5
__C.CLUSTERING.FEAT_KEY = 'feat'
__C.CLUSTERING.HISTORY_LEN = 2

# CDD options
__C.CDD = edict()
__C.CDD.KERNEL_NUM = (8, 8)
__C.CDD.KERNEL_MUL = (2, 2)
__C.CDD.LOSS_WEIGHT = 0.8
